...
describe("Converters", () => {
    ...
    describe("convertCommandDataToMatter - PascalCase normalization (issue #172)", () => {
        ...
        it("should convert webRtcSessionID to webRtcSessionId for WebRtcTransportProvider ProvideOffer", () => {
            // HA's matter camera integration sends the wire name generated by this project's
            // own Python client (python_client/chip/clusters/cluster_defs/WebRtcTransportProvider.py:
            // webRtcSessionID, capital ID) for a fresh offer, with a null session id since it is
