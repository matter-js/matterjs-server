...
class LaundryDryerControls(Cluster):
    ...
    def descriptor(cls) -> ClusterObjectDescriptor:
        return ClusterObjectDescriptor(
            Fields=[
                ClusterObjectFieldDescriptor(Label="supportedDrynessLevels", Tag=0x00000000, Type=typing.List[typing.Optional[LaundryDryerControls.Enums.DrynessLevelEnum]]),
    ...
    supportedDrynessLevels: 'typing.List[typing.Optional[LaundryDryerControls.Enums.DrynessLevelEnum]]' = field(default_factory=lambda: [])
    ...
    class Attributes:
        ...
        class SupportedDrynessLevels(ClusterAttributeDescriptor):
            ...
            def attribute_type(cls) -> ClusterObjectFieldDescriptor:
                return ClusterObjectFieldDescriptor(Type=typing.List[typing.Optional[LaundryDryerControls.Enums.DrynessLevelEnum]])

            value: 'typing.List[typing.Optional[LaundryDryerControls.Enums.DrynessLevelEnum]]' = field(default_factory=lambda: [])
