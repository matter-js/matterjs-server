...
class PowerTopology(Cluster):
    ...
    def descriptor(cls) -> ClusterObjectDescriptor:
        return ClusterObjectDescriptor(
            Fields=[
                ClusterObjectFieldDescriptor(Label="availableEndpoints", Tag=0x00000000, Type=typing.Optional[typing.List[typing.Optional[uint]]]),
                ClusterObjectFieldDescriptor(Label="activeEndpoints", Tag=0x00000001, Type=typing.Optional[typing.List[typing.Optional[uint]]]),
    ...
    availableEndpoints: 'typing.Optional[typing.List[typing.Optional[uint]]]' = None
    activeEndpoints: 'typing.Optional[typing.List[typing.Optional[uint]]]' = None
