...
class AudioOutput(Cluster):
    ...
    def descriptor(cls) -> ClusterObjectDescriptor:
        return ClusterObjectDescriptor(
            Fields=[
                ClusterObjectFieldDescriptor(Label="outputList", Tag=0x00000000, Type=typing.List[typing.Optional[AudioOutput.Structs.OutputInfoStruct]]),
    ...
    outputList: 'typing.List[typing.Optional[AudioOutput.Structs.OutputInfoStruct]]' = field(default_factory=lambda: [])
    ...
    class Attributes:
        ...
        class OutputList(ClusterAttributeDescriptor):
            ...
            def attribute_type(cls) -> ClusterObjectFieldDescriptor:
                return ClusterObjectFieldDescriptor(Type=typing.List[typing.Optional[AudioOutput.Structs.OutputInfoStruct]])

            value: 'typing.List[typing.Optional[AudioOutput.Structs.OutputInfoStruct]]' = field(default_factory=lambda: [])
