            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields=[
                        ...
                        ClusterObjectFieldDescriptor(Label="modeTags", Tag=2, Type=typing.List[typing.Optional[DeviceEnergyManagementMode.Structs.ModeTagStruct]]),
                    ])

            label: 'str' = ""
            mode: 'uint' = 0
            modeTags: 'typing.List[typing.Optional[DeviceEnergyManagementMode.Structs.ModeTagStruct]]' = field(default_factory=lambda: [])
