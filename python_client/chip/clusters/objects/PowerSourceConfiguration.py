...
class PowerSourceConfiguration(Cluster):
    ...
    def descriptor(cls) -> ClusterObjectDescriptor:
        return ClusterObjectDescriptor(
            Fields=[
                ClusterObjectFieldDescriptor(Label="sources", Tag=0x00000000, Type=typing.List[typing.Optional[uint]]),
    ...
    sources: 'typing.List[typing.Optional[uint]]' = field(default_factory=lambda: [])
