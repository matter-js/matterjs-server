...
class Binding(Cluster):
    ...
    def descriptor(cls) -> ClusterObjectDescriptor:
        return ClusterObjectDescriptor(
            Fields=[
                ClusterObjectFieldDescriptor(Label="binding", Tag=0x00000000, Type=typing.List[typing.Optional[Binding.Structs.TargetStruct]]),
    ...
    binding: 'typing.List[typing.Optional[Binding.Structs.TargetStruct]]' = field(default_factory=lambda: [])
    ...
    class Attributes:
        ...
        class Binding(ClusterAttributeDescriptor):
            ...
            def attribute_type(cls) -> ClusterObjectFieldDescriptor:
                return ClusterObjectFieldDescriptor(Type=typing.List[typing.Optional[Binding.Structs.TargetStruct]])

            value: 'typing.List[typing.Optional[Binding.Structs.TargetStruct]]' = field(default_factory=lambda: [])
