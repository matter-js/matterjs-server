...
class ActivatedCarbonFilterMonitoring(Cluster):
    ...
    def descriptor(cls) -> ClusterObjectDescriptor:
        return ClusterObjectDescriptor(
            Fields=[
                ...
                ClusterObjectFieldDescriptor(Label="replacementProductList", Tag=0x00000005, Type=typing.Optional[typing.List[typing.Optional[ActivatedCarbonFilterMonitoring.Structs.ReplacementProductStruct]]]),
    ...
    replacementProductList: 'typing.Optional[typing.List[typing.Optional[ActivatedCarbonFilterMonitoring.Structs.ReplacementProductStruct]]]' = None
    ...
    class Attributes:
        ...
        class ReplacementProductList(ClusterAttributeDescriptor):
            ...
            @ChipUtility.classproperty
            def attribute_type(cls) -> ClusterObjectFieldDescriptor:
                return ClusterObjectFieldDescriptor(Type=typing.Optional[typing.List[typing.Optional[ActivatedCarbonFilterMonitoring.Structs.ReplacementProductStruct]]])

            value: 'typing.Optional[typing.List[typing.Optional[ActivatedCarbonFilterMonitoring.Structs.ReplacementProductStruct]]]' = None
