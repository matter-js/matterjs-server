...
- Enhancement: Dashboard network view uses the Thread 1.4 role names: a Thread Router is shown as "Mesh Extender" and a REED as "Standby Mesh Extender". Wire values and the `ThreadRoutingRole` enum keep the Matter spec names
